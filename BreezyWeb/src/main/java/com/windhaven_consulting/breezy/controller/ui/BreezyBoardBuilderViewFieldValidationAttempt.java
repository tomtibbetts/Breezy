...
@ManagedBean
@ViewScoped
public class BreezyBoardBuilderViewFieldValidationAttempt implements Serializable {
	 ...
	 * 
	 */
	public void saveExtension(ActionEvent event) {
		RequestContext context = RequestContext.getCurrentInstance();
		FacesMessage message = null;
		
		boolean isValid = false;
		
		if(StringUtils.isNotEmpty(workingExtension.getName())) {
			...
			isValid = true;
			message = new FacesMessage(FacesMessage.SEVERITY_INFO, "Loggin Success", "Good credentials");
		}
		else {
